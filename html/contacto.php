...
<head>
	...
	<h1 class="text-center">Amador Carmona Mendez</h1>
	<div class="text-center">
	<img class="sm-auto" width="200" height="270" src="http://bahia.ugr.es/~pw15520560/pe2/imagenes/amador.jpg">
	<p>Amador Carmona Méndez, Villanueva del Arzobispo (Jaén), 21 años. Estudiante del grado en Ingeniería Informática en la Escuela Tecnica Superior de Ingenieria Informatica y Telecomunicaciones de la Universidad de Granada. Ha creado esta página web para la asignatura de Programacion web.</p>
	<!--<a href="https://www.instagram.com/amador.cm/">Instagram</a>-->
	<p>Correo: amadorcm@correo.ugr.es</p>
</div>
