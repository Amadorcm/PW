...
<html>
	...
	<body class="bg-secondary bg-opacity-10">
		...
		<main>
			<div class="row">
				<section class="sm">
					<h2 class="text-center" id="secc">Escultura</h2>
					<div class="row text-center">
						<article class="col-sm-6">
							<a class="link-secondary" href="http://bahia.ugr.es/~pw15520560/pe2/html/exposiciones/expo1.php">
								<img class="img-fluid" id="imgen" src="http://bahia.ugr.es/~pw15520560/pe2/imagenes/exp1.0.jpeg">
								<h3 id="nombre">Exposicion griega</h3>
						...
						<article class="col-sm-6">
							<a class="link-secondary" href="http://bahia.ugr.es/~pw15520560/pe2/html/exposiciones/expo1.php">
								<img class="img-fluid" src="http://bahia.ugr.es/~pw15520560/pe2/imagenes/exp1.0.jpeg">
								<h3>Exposicion griega </h3>
							</a>
							<p>Autor Benulli</p>
						</article>
