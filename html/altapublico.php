...
<head>
	...
	<main>
		<h2 class="text-center">Dar de Alta a Publico</h2>
		<br>
		<br>
		<form class="text-center" name="altapublico" method="get" action="altapublico_script.php" onsubmit="return validarAltaPublico()">
			<label for="NombreUsuario">Nombre Usuario:</label>
		<input type="text" name="NombreUsuario" placeholder = "Xxxxxx" >
		<br>
		<label for="Passw">Contraseña:</label>
		<input type="text" name="Passw" placeholder = "xxxxxxx">
		<br>
  		...
  		//var CryptoJS = require("crypto-js");
			function validarAltaPublico(){
	   		...
	   		if (document.altapublico.Passw.value.length==0){
	      		alert("Tiene que escribir su contraseña");
	      		return false;
	   		}else{//encriptar contraseña --> No vale :(
	   			var contra = CryptoJS.AES.encrypt('my message', 'secret key 123')
	   			document.altapublico.Passw.value=contra;
	   			break;
	   		}
