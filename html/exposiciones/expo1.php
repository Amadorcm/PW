...
<html>
	...
	<body class="bg-secondary bg-opacity-10">
		...
		<main>
			<h1 class="text-center">Esculturas griegas</h1>
			<div class="row">
				<img class="col-sm-4 img-fluid"src="http://bahia.ugr.es/~pw15520560/pe2/imagenes/exp1.0.jpeg" width="400" height="300">
				<p class="col-sm-8"> Cultivó el arte de la Antigua Grecia todos los géneros de escultura, adoptando con materiales el mármol y el bronce como material escultórico y tomando como asuntos principales los mitológicos y los guerreros a los cuales añadió en su última época el retrato de personajes históricos.Forman su característica en los mejores tiempos del Arte (los de Fidias) la expresión de la realidad idealizada, la regular proporción orgánica, el alejamiento de lo vago y monstruoso, la precisión en los contornos y detalles, la armonía y belleza en las formas y la finura en la ejecución.</p>
			</div class="row">
			<br>
			<br>
			<div class="row">
					...
					<div class="row">
						<article class="col-sm-4">
							<a class="link-secondary" href="http://bahia.ugr.es/~pw15520560/pe2/html/exposiciones/pieza1expo1.php">
								<img class="img-fluid" src="http://bahia.ugr.es/~pw15520560/pe2/imagenes/exp1.1.jpeg">
								<h3>Pieza 1: Estatua del Discobolo</h3>
							</a>
							<p>Autor Benulli</p>
						</article>
						<article class="col-sm-4">
